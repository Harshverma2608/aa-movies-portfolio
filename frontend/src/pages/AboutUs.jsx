  ...
  return (
    <div className="bg-[#fbf9f4] text-[#1b1c19]">
      ...
      <section className="relative flex items-center overflow-hidden" style={{ height: '100dvh' }}>
        ...
        <div className="relative z-10 px-6 sm:px-12 max-w-7xl mx-auto w-full pt-20">
          <p className="animate-fade-up text-[10px] tracking-[0.5em] uppercase mb-4 sm:mb-6" style={{ color: '#e9c176' }}>Our Essence</p>
          <h1 className="animate-fade-up-delay font-[Noto_Serif] leading-[1.05] font-light mb-6 sm:mb-8 italic text-[#fbf9f4]"
            style={{ fontSize: 'clamp(2.2rem, 8vw, 6rem)' }}>
            Capturing the <br />Quiet Moments
          </h1>
          <p className="animate-fade-up-delay2 opacity-75 max-w-md leading-relaxed text-[#fbf9f4]"
      ...
      {/* PHILOSOPHY */}
      <section className="bg-[#f5f3ee] py-16 sm:py-24 lg:py-32 px-6 sm:px-12">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-12 md:gap-24 reveal">
          <div className="md:w-1/3">
            ...
            <h2 className="font-[Noto_Serif] font-light leading-tight" style={{ fontSize: 'clamp(1.8rem, 4vw, 2.5rem)' }}>The Philosophy<br />of Time</h2>
          </div>
          <div className="md:w-2/3 grid grid-cols-1 sm:grid-cols-2 gap-8 sm:gap-16">
            {[
      ...
      {/* APPROACH */}
      <section className="py-16 sm:py-24 lg:py-32 px-6 sm:px-12 bg-[#fbf9f4]">
        <div className="max-w-7xl mx-auto">
          <div className="mb-10 sm:mb-16 reveal">
            <p className="text-[10px] tracking-[0.4em] uppercase text-[#775a19] mb-4">How We Work</p>
            <h2 className="font-[Noto_Serif] font-light" style={{ fontSize: 'clamp(2rem, 5vw, 3rem)' }}>The A&amp;A Approach</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            {steps.map((s, i) => (
              <div key={i} className={`md:col-span-4 bg-white p-8 sm:p-12 transition-all duration-500 hover:shadow-[0_20px_40px_rgba(27,28,25,0.06)] reveal reveal-delay-${i+1}`}>
                <span className="font-[Noto_Serif] text-5xl italic mb-8 block" style={{ color: '#e9c176' }}>{s.num}</span>
                <h3 className="font-[Noto_Serif] text-xl sm:text-2xl mb-4">{s.title}</h3>
                <p className="text-[#4e4639] text-sm leading-relaxed">{s.body}</p>
              </div>
            ))}
            <div className="md:col-span-8 overflow-hidden reveal" style={{ minHeight: '220px' }}>
              <img src={IMG.img4} alt="Event" className="w-full h-full object-cover" style={{ filter: 'grayscale(30%)' }} />
            </div>
            <div className="md:col-span-4 overflow-hidden reveal reveal-delay-1" style={{ minHeight: '220px' }}>
      ...
      {/* TEAM */}
      <section className="py-16 sm:py-24 lg:py-32 px-6 sm:px-12 bg-[#f0eee9]">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 sm:mb-20 reveal gap-6">
            <div className="max-w-xl">
              <p className="text-[10px] tracking-[0.4em] uppercase text-[#775a19] mb-4">The Artisans</p>
              <h2 className="font-[Noto_Serif] font-light" style={{ fontSize: 'clamp(2rem, 5vw, 3rem)' }}>The Minds Behind the Lens</h2>
            </div>
            <p className="font-[Noto_Serif] text-[#4e4639] text-sm italic">A collective of visionaries dedicated to the art of seeing.</p>
          </div>
      ...
      {/* DARK QUOTE */}
      <section className="py-16 sm:py-24 px-6 sm:px-12 bg-[#1b1c19] text-center relative overflow-hidden">
      ...
      {/* CTA */}
      <section className="py-24 sm:py-32 lg:py-40 px-6 sm:px-12 text-center bg-[#fbf9f4] relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto relative z-10 reveal">
          <p className="text-[10px] tracking-[0.5em] uppercase text-[#775a19] mb-8 sm:mb-12">Start Your Story</p>
          <h2 className="font-[Noto_Serif] font-light mb-8 sm:mb-12 italic"
            style={{ fontSize: 'clamp(2rem, 6vw, 4rem)' }}>
            Shall we create something timeless?
          </h2>
          <div className="flex flex-col sm:flex-row justify-center gap-4 sm:gap-6">
            <a href={WA_LINK} target="_blank" rel="noreferrer">
              <button className="gold-gradient text-[#261900] px-10 sm:px-12 py-4 sm:py-5 text-xs tracking-widest uppercase font-bold rounded-sm shadow-[0_20px_40px_rgba(119,90,25,0.2)] hover:scale-[1.02] transition-transform duration-500 animate-gold-pulse">
                Inquire Now
              </button>
            </a>
            <Link to="/gallery">
